...
import { addVehicle, useGetAllVehicles } from "../../queries/useVehicles";
...
export default function Vehicles(props) {
  ...
  } = useGetAllVehicles({ url });

  const addVehicleMutation = useMutation(addVehicle, {
    onSettled: () => refetchVehicles(),
  });

  if (isVehiclesLoading) return <IsLoadingUI />;
  return (
    <>
            ...
            <div className="grid ">
              ...
              <div className="flex w-full">
                <div className="grid flex-grow ">
                  <h2 className="text-xl font-bold">Add New Vehicles</h2>
                  {addNewVehicles()}
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="form-floating mb-3 xl:w-96">
                <Field
                  ...
                  placeholder="passenger_capacity"
                />
              </div>
    ...
    return (
      <div className="stats shadow">
        <div className="stat">
          ...
          <div className="stat-title">Number of Vehicles</div>
